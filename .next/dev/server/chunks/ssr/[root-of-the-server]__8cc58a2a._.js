...
;
const metadata = {
    title: "CVWEBX - Create Your Web Resume in 5 Minutes",
    description: "Build stunning, interactive web resumes with CVWEBX. 5 premium templates designed to impress recruiters. Just ₹499. No subscriptions.",
    keywords: "web resume, portfolio resume, job resume, interactive resume, web portfolio",
    generator: "v0.app",
    icons: {
        icon: [
            {
